...
<div class="container">
    ...
    <div class="wrap">
        <div id="connecting">
            <h4><b>Connecting</b></h4>

            <p>So, you want to get on the chat? To do that, you might want to first know what you're
                connecting to. It's
                called <a rel="tooltip" class="tooltip-call" title="Internet Relay Chat">IRC</a>, and you can <a
                    ...
                    more
                    about it on Wikipedia</a>. If you have no idea what IRC is and are a newbie, feel free to click the
                button below to open a new window to chat in. Otherwise, if you have a client and know what you're
                doing, then feel free to
                connect
                with <a rel="tooltip" class="tooltip-call" title="#lgbteens @ irc.awfulnet.org">these details</a> and <a
                        href="#nickserv">skip
                    ahead to the next chapter</a>. For those who aren't as familiar, you might've noticed the term
                ...
                <a href="http://webchat.awfulnet.org:9001/?channels=#lgbteens" target="_blank" class="m-btn black">Start Chatting <i class="m-icon-swapright m-icon-white"></i></a>
                <br><br>
                Once you've connected, you're going to want to change your nickname, to do this do
        ...
        <div id="etiquette">
            <h4><b>How to IRC</b></h4>

            <p>
                There are many accepted rules to being on IRC, one such courtesy is when talking to somebody directly,
                to append their nickname at the beginning of the message. Most clients available have username
                auto-complete, so you should only need to type the first few letters then be able to hit the [tab] key
                and it should finish it for you, then when you send the message, they will receive a notification. The
        ...
        <div id="nickserv">
            <h4><b>Registering with NickServ</b></h4>
            ...
            <p>
                ...
                NickServ is a service provided by the IRC network (the people that run the
                chat service), which helps user identify themselves, and keeps other people from stealing your name. It
                ...
                that nickname. To register a nickname, all you need to do is:
                <br>
                <code>/msg nickserv register [password] [email]</code>
                <br>
                Replace password and email respectively, and remove the brackets... and you're done! NickServ should now
                have sent an email asking you to verify the registration, all you
                need to do is follow the instructions in the email to finish the registration process. Now, take note,
                ...
                <br>
                Once again, remove the brackets and replace password with your password. And that's it! You're logged
        ...
        <div id="info">
            <h4><b>SLAPASS (Tell us About Yourself)</b></h4>

            <p>
                SLAPASS stands for Sex, Location, Age, Picture, Aspirations or Goals, Sexuality, and Starsign. What's
                this information used for? It's so that others in the chat can know who you are. All they need to do is
                <code>!info [username]</code> and it gives them that user's SLAPASS information. If you don't wnat to
                have one, and stay anonymous, that's fine. But if you do want to, just do the following command in the
                chat:
                <br>
                ...
                Note, when adding your information, make sure the "/" have spaces around them. This makes it easier for
